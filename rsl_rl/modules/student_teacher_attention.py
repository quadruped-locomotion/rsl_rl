...
class StudentTeacherAttention(nn.Module):
    ...
    def __init__(
        ...
        teacher_hidden_dims: list[int] = [512, 256, 128], # TODO: single source of truth
        ...
        **kwargs,
        ...
        for obs_group in obs_groups["policy"]:
            assert len(obs[obs_group].shape) == 2, "The StudentTeacherAttention module only supports 1D observations."
        ...
        num_query_s = exteroception_offset if exteroception_offset > 0 else num_student_obs + exteroception_offset
        mlp_input_dim_s = num_query_s + attention_hidden_dim
